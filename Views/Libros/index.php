...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Nueva Asignatura</h1>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="title">Registro de Asignacion</h5>
                ...
                <form id="frmLibro" class="row" onsubmit="registrarLibro(event)">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="titulo">Asignatura</label>
                            <input type="hidden" id="id" name="id">
                            <input id="titulo" class="form-control" type="text" name="titulo" placeholder="Nombre de la Asignatura" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="autor">Profesor</label><br>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="editorial">Procedimiento</label><br>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="cantidad">Intento</label>
                            <input id="cantidad" class="form-control" type="text" name="cantidad" placeholder="Intento" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="num_pagina">Cantidad de Intentos</label>
                            <input id="num_pagina" class="form-control" type="number" name="num_pagina" placeholder="Cantidad de Intentos" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="anio_edicion">Fecha de la Asignacion</label>
