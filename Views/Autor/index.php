    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-white" id="title">Registrar Profesor</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="autor" class="form-control" type="text" name="autor" required placeholder="Nombre del Profesor" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
