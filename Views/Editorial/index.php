...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Procedimiento</h1>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-white" id="title">Registro de Procedimiento</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="editorial">Tipo</label>
                                <input type="hidden" id="id" name="id">
                                <input id="editorial" class="form-control" type="text" name="editorial" required placeholder="Tipo de Procedimiento">
                            </div>
                        </div>
